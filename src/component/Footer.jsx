...
function Footer() {
  return (
    <div className="w-full h-screen bg-zinc-900 py-16 px-20 flex overflow-hidden font-['Founders Grotesk X-Condensed'] ">
      <div className="w-1/2 flex flex-col justify-between h-full ">
        <div className="heading">
          <h1 className="text-[8vw] tracking-tighter font-semibold uppercase leading-none -mb-6">
            Eye-
          </h1>
          <h1 className="text-[8vw] tracking-tighter font-semibold uppercase leading-none -mb-6">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="uppercase text-[7.1vw] -tracking-[.5vw] font-semibold  -mb-6">
          presentations
        </h1>
        <div className="dets font-['Neue Montreal '] mt-20">
          {["Facebook", "Instagram", "Twitter","Linkdin"].map((e) => (
            <a href="" className='block text-2xl font-light '>{e}</a>
          ))}
        </div>
      </div>
    </div>
